...
let stories = [
	...
	'What if I were a cloud',
	'What if I were a waterfall',
	'What if I were a waterfall',
	''
];

let narrationDiv = document.getElementById('narration-div');
...
function changeText(){
	...
	narrationText.innerHTML = stories[sectionNum];
	// Map vertical scroll position to the horizontal position of the cat
	narrationDiv.style.left = pos / (height * 8) * width + 'px';
